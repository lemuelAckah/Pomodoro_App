...
const SICON_PATHS = {
  ...
  sparkle:
    '<path d="M12 3l1.9 5.8 5.8 1.9-5.8 1.9L12 18.4l-1.9-5.8L4.3 10.7l5.8-1.9z"/><path d="M18.6 15.4l.8 2.3 2.3.8-2.3.8-.8 2.3-.8-2.3-2.3-.8 2.3-.8z"/>',

  heart:
    '<path fill="currentColor" stroke="none" d="M12 20.5S3.5 15.4 3.5 9.6C3.5 7 5.5 5 8 5c1.6 0 3.1.9 4 2.2C12.9 5.9 14.4 5 16 5c2.5 0 4.5 2 4.5 4.6 0 5.8-8.5 10.9-8.5 10.9z"/>',

  heartOutline:
    '<path d="M12 20.5S3.5 15.4 3.5 9.6C3.5 7 5.5 5 8 5c1.6 0 3.1.9 4 2.2C12.9 5.9 14.4 5 16 5c2.5 0 4.5 2 4.5 4.6 0 5.8-8.5 10.9-8.5 10.9z"/>',
  ...
  coins:
    '<ellipse cx="10" cy="7.5" rx="6.5" ry="3"/><path d="M3.5 7.5v9c0 1.7 2.9 3 6.5 3 1.2 0 2.4-.1 3.3-.4"/><path d="M13.8 10.8v5.7c0 1.4 2.3 2.5 5.4 2.5"/>',
  ...
  trophy:
    '<path d="M8 4h8v5a4 4 0 0 1-8 0z"/><path d="M8 5.5H4.8A3.7 3.7 0 0 0 8.5 9M16 5.5h3.2A3.7 3.7 0 0 1 15.5 9"/><path d="M12 13v3.5M8.5 20.5h7M10 16.5h4"/>',

  medal:
    '<circle cx="12" cy="14" r="5"/><path d="M9.2 9.7L6.5 3.5h3.6L12 8.3l1.9-4.8h3.6l-2.7 6.2"/>',

  target:
    '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/>',

  crown:
    '<path d="M3.5 8l4.5 3.5L12 5l4 6.5L20.5 8 19 17H5z"/><path d="M5.5 20.5h13"/>',

  gem: '<path d="M7 3.5h10l4 5.5-9 11.5L3 9z"/><path d="M3 9h18M9.5 9L12 20.5 14.5 9M7 3.5L9.5 9h5L17 3.5"/>',

  rocket:
    '<path d="M12 2.5c2.8 1.8 4.2 5.2 4.2 8.7l-2.4 2.6h-3.6l-2.4-2.6c0-3.5 1.4-6.9 4.2-8.7z"/><circle cx="12" cy="9" r="1.6"/><path d="M7.8 13.8L6 19.5l4.3-1.8M16.2 13.8l1.8 5.7-4.3-1.8"/><path d="M10.5 18c0 1.4.7 2.4 1.5 3.2.8-.8 1.5-1.8 1.5-3.2"/>',

  comet:
    '<circle cx="16.5" cy="7.5" r="3.5"/><path d="M13 11L4.5 19.5M13.5 14.5L8 20M10 12L4.5 14"/>',

  smile:
    '<circle cx="12" cy="12" r="8.5"/><circle cx="9" cy="10" r="1" fill="currentColor" stroke="none"/><circle cx="15" cy="10" r="1" fill="currentColor" stroke="none"/><path d="M8.5 14.3c1 1.6 2.2 2.3 3.5 2.3s2.5-.7 3.5-2.3"/>',

  laugh:
    '<circle cx="12" cy="12" r="8.5"/><path d="M7.5 10.5l1.8-1.8 1.8 1.8M12.9 10.5l1.8-1.8 1.8 1.8"/><path d="M7.8 13.8c1.2 2.2 2.6 3.2 4.2 3.2s3-1 4.2-3.2"/>',
  ...
  thumbsUp:
    '<path d="M7 11.5V19H4.7A1.7 1.7 0 0 1 3 17.3v-4.1a1.7 1.7 0 0 1 1.7-1.7z"/><path d="M7 11.5l3.8-7c1.2 0 2 1 1.7 2.1L11.3 11H18.8a1.6 1.6 0 0 1 1.6 1.9l-1.2 5.2a2 2 0 0 1-2 1.6H7"/>',
  ...
  strong:
    '<path d="M6.5 20v-5.5L9.5 7c.5-1.1 1.9-1.3 2.6-.4L14.5 9H19a1.5 1.5 0 0 1 1.4 2.1l-1.6 5.2a2 2 0 0 1-1.9 1.5H10z"/>',
  ...
  download:
    '<path d="M12 3.5v11M7.5 10.5L12 15l4.5-4.5"/><path d="M4.5 19.5h15"/>',
  ...
  calendar:
    '<rect x="4" y="5.5" width="16" height="15" rx="2"/><path d="M4 10h16M8.5 3v4M15.5 3v4"/>',

  book: '<path d="M6 3.5h12A1.5 1.5 0 0 1 19.5 5v14a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1z"/><path d="M9 8.5h6M9 12h6"/>',

  bookOpen:
    '<path d="M12 6.5C10 4.8 7 4.5 4 5v13c3-.5 6-.2 8 1.5 2-1.7 5-2 8-1.5V5c-3-.5-6-.2-8 1.5z"/><path d="M12 6.5v13"/>',

  shield:
    '<path d="M12 2.8l7.5 3v6c0 5-3.2 8.3-7.5 9.7-4.3-1.4-7.5-4.7-7.5-9.7v-6z"/><path d="M9 11.8l2.2 2.2 4.3-4.5"/>',

  sprout:
    '<path d="M12 21v-8"/><path d="M12 13c0-4 3-7 8-7 0 4-3 7-8 7z"/><path d="M12 13c0-3-2.5-5-6-5 0 3 2.5 5 6 5z"/>',
  ...
  flower:
    '<circle cx="12" cy="12" r="2.1"/><circle cx="12" cy="7" r="2.4"/><circle cx="16.8" cy="10.6" r="2.4"/><circle cx="15" cy="16.1" r="2.4"/><circle cx="9" cy="16.1" r="2.4"/><circle cx="7.2" cy="10.6" r="2.4"/>',

  lotus:
    '<path d="M12 17c-4 0-7.5-2.5-9-6 2.8-.3 5.2.3 7 1.7.5-2.7 1-5.2 2-7.7 1 2.5 1.5 5 2 7.7 1.8-1.4 4.2-2 7-1.7-1.5 3.5-5 6-9 6z"/><path d="M4 20h16"/>',

  party:
    '<path d="M5.5 14.5L14.5 5.5l2.5 2.5-9 9z"/><path d="M5.5 14.5L4.5 19.5l5-1"/><path d="M14.5 4.5L16 3M17 6.5l1.8-.8M18.3 9.5l1.9.4M6.5 5L5 3.5M4 7.7L2.2 7.2"/>',

  brain:
    '<path d="M9.6 3.6A2.5 2.5 0 0 0 7 6.1c-1.6.3-2.9 1.7-2.9 3.5 0 .9.4 1.8 1 2.4a3.5 3.5 0 0 0 .4 4.4c.7.7 1.6 1.1 2.5 1.1.4 1.4 1.7 2.4 3.1 2.4h1.8c1.4 0 2.7-1 3.1-2.4.9 0 1.8-.4 2.5-1.1a3.5 3.5 0 0 0 .4-4.4c.6-.6 1-1.5 1-2.4 0-1.8-1.3-3.2-2.9-3.5a2.5 2.5 0 0 0-2.6-2.5c-.7 0-1.3.3-1.8.8-.4-.5-1-.8-1.7-.8z"/><path d="M12 4.2V20"/>',
  ...
  sunrise:
    '<path d="M4 18.5h16"/><path d="M7.5 18.5a4.5 4.5 0 0 1 9 0"/><path d="M12 8.5V2.5M9.5 5L12 2.5 14.5 5M4.5 10.5l1.5 1.5M19.5 10.5L18 12"/>',

  moon: '<path d="M20 14.5A8 8 0 0 1 9.5 4 8 8 0 1 0 20 14.5z"/>',

  storm:
    '<path d="M7 12.5a4.5 4.5 0 1 1 .8-8.9A5.5 5.5 0 0 1 18.5 5.5 3.8 3.8 0 0 1 17.5 12.5z"/><path d="M12.5 12.5L10 18h3l-2 4"/>',
  ...
  coffee:
    '<path d="M5 9.5h11V15a4.5 4.5 0 0 1-4.5 4.5h-2A4.5 4.5 0 0 1 5 15z"/><path d="M16 10.5h1.8a2.6 2.6 0 0 1 0 5.2H16"/><path d="M8.5 6c0-1.2.9-1.2.9-2.4M12.5 6c0-1.2.9-1.2.9-2.4"/>',
  ...
  music:
    '<circle cx="7" cy="17.5" r="3"/><circle cx="17.5" cy="15.5" r="3"/><path d="M10 17.5V6l10-2.5V15.5"/>',

  headphones:
    '<path d="M4 15v-2a8 8 0 0 1 16 0v2"/><rect x="3" y="14" width="4.5" height="7" rx="2"/><rect x="16.5" y="14" width="4.5" height="7" rx="2"/>',

  mic: '<rect x="9" y="2.5" width="6" height="11" rx="3"/><path d="M6 11.5a6 6 0 0 0 12 0M12 17.5V21"/>',

  camera:
    '<rect x="3" y="7" width="18" height="13" rx="2.5"/><circle cx="12" cy="13.5" r="3.5"/><path d="M8.5 7L10 4.5h4L15.5 7"/>',
  ...
  palette:
    '<path d="M12 3.5a8.5 8.5 0 1 0 0 17c1.4 0 2-.9 2-2 0-1.6-1.4-2-1.4-3.4 0-1.2 1-2.1 2.2-2.1H17a4.5 4.5 0 0 0 4.5-4.5c0-2.8-4-5-9.5-5z"/><circle cx="8" cy="10.2" r="1" fill="currentColor" stroke="none"/><circle cx="12" cy="7.6" r="1" fill="currentColor" stroke="none"/><circle cx="16" cy="10.2" r="1" fill="currentColor" stroke="none"/>',
  ...
  globe:
    '<circle cx="12" cy="12" r="8.5"/><path d="M3.5 12h17M12 3.5c-4.6 4.6-4.6 12.4 0 17M12 3.5c4.6 4.6 4.6 12.4 0 17"/>',

  map: '<path d="M9 4L4 6v14l5-2 6 2 5-2V4l-5 2z"/><path d="M9 4v14M15 6v14"/>',

  robot:
    '<rect x="5" y="9.5" width="14" height="9.5" rx="2.5"/><circle cx="9.5" cy="14.2" r="1" fill="currentColor" stroke="none"/><circle cx="14.5" cy="14.2" r="1" fill="currentColor" stroke="none"/><path d="M9.5 16.8h5M12 5.5V9.5"/><circle cx="12" cy="4" r="1.2"/>',

  flask:
    '<path d="M10 2.5h4M10.5 2.5V8l-5.4 10.8A1.5 1.5 0 0 0 6.4 21h11.2a1.5 1.5 0 0 0 1.3-2.2L13.5 8V2.5"/><path d="M8.2 14.5h7.6"/>',

  cross: '<circle cx="12" cy="12" r="8.5"/><path d="M12 8.5v7M8.5 12h7"/>',

  dice: '<rect x="4" y="4" width="16" height="16" rx="4.5"/><circle cx="9" cy="9" r="1.4" fill="currentColor" stroke="none"/><circle cx="15" cy="9" r="1.4" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none"/><circle cx="9" cy="15" r="1.4" fill="currentColor" stroke="none"/><circle cx="15" cy="15" r="1.4" fill="currentColor" stroke="none"/>',

  users:
    '<circle cx="9" cy="8.5" r="3"/><path d="M3.5 19c0-3 2.5-5 5.5-5s5.5 2 5.5 5"/><circle cx="16.5" cy="9.5" r="2.4"/><path d="M16.2 14.3c2.2.4 3.8 2 3.8 4.2"/>',
  ...
  refresh:
    '<path d="M19.5 12a7.5 7.5 0 0 1-13 5.1M4.5 12a7.5 7.5 0 0 1 13-5.1"/><path d="M18 3.5V8h-4.5M6 20.5V16h4.5"/>',

  trash:
    '<path d="M4.5 6.5h15M9.5 6V4.5A1.5 1.5 0 0 1 11 3h2a1.5 1.5 0 0 1 1.5 1.5V6"/><path d="M6.5 6.5l1 13a1.5 1.5 0 0 0 1.5 1.4h6a1.5 1.5 0 0 0 1.5-1.4l1-13"/><path d="M10 10.5v6M14 10.5v6"/>',

  flag: '<path d="M6 21V4"/><path d="M6 4.5c4-2 7 2 12 0v9c-5 2-8-2-12 0"/>',

  mountain:
    '<path d="M3 19L10 7l4 6 2.5-3.5L21 19z"/><circle cx="17" cy="5.5" r="1.6"/>',

  timer:
    '<circle cx="12" cy="13" r="7.5"/><path d="M12 9.5V13l2.5 2M9.5 2.5h5M12 2.5V5.5"/>',

  ghost:
    '<path d="M6 20.5v-8a6 6 0 0 1 12 0v8l-2-1.5-2 1.5-2-1.5-2 1.5-2-1.5z"/><circle cx="10" cy="11" r="1" fill="currentColor" stroke="none"/><circle cx="14" cy="11" r="1" fill="currentColor" stroke="none"/>',

  pumpkin:
    '<ellipse cx="12" cy="13.5" rx="7.5" ry="6"/><path d="M12 8v5.5M12 8c0-2.2 1-3.2 2.6-3.7M9 13.2v.6M15 13.2v.6"/>',
  ...
  butterfly:
    '<ellipse cx="8.3" cy="11.5" rx="3.4" ry="4.8" transform="rotate(-18 8.3 11.5)"/><ellipse cx="15.7" cy="11.5" rx="3.4" ry="4.8" transform="rotate(18 15.7 11.5)"/><path d="M12 8.5V20M10.6 8.5L9.6 6M13.4 8.5l1-2.5"/>',
  ...
  volume:
    '<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15 9a4.5 4.5 0 0 1 0 6M17.5 6.5a8 8 0 0 1 0 11"/>',

  mute: '<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 9.5l5 5M20.5 9.5l-5 5"/>',

  question:
    '<circle cx="12" cy="12" r="8.5"/><path d="M9.5 9.5a2.5 2.5 0 1 1 3.6 2.2c-.8.4-1.1 1-1.1 1.8"/><circle cx="12" cy="17" r="1" fill="currentColor" stroke="none"/>',

  hundred:
    '<rect x="2.5" y="7" width="19" height="10" rx="5"/><text x="12" y="14.6" text-anchor="middle" font-size="8" font-weight="800" fill="currentColor" stroke="none">100</text>',
  ...
  seven:
    '<path d="M9.5 9.5L7 3.5h3.4L12 8l1.6-4.5H17l-2.5 6"/><circle cx="12" cy="14.5" r="5"/><text x="12" y="16.9" text-anchor="middle" font-size="7" font-weight="800" fill="currentColor" stroke="none">7</text>',

  wheel:
    '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="1.4"/><path d="M12 3.5V12M12 12l7.4 4.3M12 12l-7.4 4.3"/>',

  expand: '<path d="M9 4H4v5M15 4h5v5M9 20H4v-5M15 20h5v-5"/>',

  planet:
    '<circle cx="12" cy="12" r="6"/><ellipse cx="12" cy="12" rx="10" ry="3.4" transform="rotate(-20 12 12)"/>',

  noise:
    '<rect x="4" y="4" width="16" height="16" rx="3"/><path d="M8 12.5h1.8l1.4-3 2 6 1.4-3H16"/>',
  ...
  "skip-back":
    '<path fill="currentColor" stroke="none" d="M6 5.4a1.3 1.3 0 0 1 2.6 0v13.2a1.3 1.3 0 0 1-2.6 0z"/><path fill="currentColor" stroke="none" d="M18.7 5.9v12.2a1 1 0 0 1-1.55.83L8.4 12.83a1 1 0 0 1 0-1.66l8.75-6.1a1 1 0 0 1 1.55.83z"/>',

  "skip-forward":
    '<path fill="currentColor" stroke="none" d="M15.4 5.4a1.3 1.3 0 0 1 2.6 0v13.2a1.3 1.3 0 0 1-2.6 0z"/><path fill="currentColor" stroke="none" d="M5.3 5.9v12.2a1 1 0 0 0 1.55.83l8.75-6.1a1 1 0 0 0 0-1.66L6.85 5.07A1 1 0 0 0 5.3 5.9z"/>',
  ...
  repeat:
    '<path d="M17 2l3 3-3 3"/><path d="M4 12V9a4 4 0 0 1 4-4h13"/><path d="M7 22l-3-3 3-3"/><path d="M20 12v3a4 4 0 0 1-4 4H3"/>',

  "repeat-one":
    '<path d="M17 2l3 3-3 3"/><path d="M4 12V9a4 4 0 0 1 4-4h13"/><path d="M7 22l-3-3 3-3"/><path d="M20 12v3a4 4 0 0 1-4 4H3"/><text x="12" y="14.5" text-anchor="middle" font-size="7" font-weight="800" fill="currentColor" stroke="none">1</text>',

  shuffle:
    '<path d="M16 3l5 5-5 5"/><path d="M21 8H9a4 4 0 0 0 0 8h2"/><path d="M16 16l5 5-5 5"/><path d="M21 20H9a4 4 0 0 1 0-8h2"/>',

  "volume-2":
    '<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15 9a4.5 4.5 0 0 1 0 6M17.5 6.5a8 8 0 0 1 0 11"/>',

  "volume-x":
    '<path d="M4 9.5v5h3.5L12 18.5v-13L7.5 9.5z"/><path d="M15.5 9.5l5 5M20.5 9.5l-5 5"/>',

  "heart-filled":
    '<path fill="currentColor" stroke="none" d="M12 20.5S3.5 15.4 3.5 9.6C3.5 7 5.5 5 8 5c1.6 0 3.1.9 4 2.2C12.9 5.9 14.4 5 16 5c2.5 0 4.5 2 4.5 4.6 0 5.8-8.5 10.9-8.5 10.9z"/>',

  reply:
    '<path d="M9.5 14L5.5 10l4-4"/><path d="M5.5 10H14a7 7 0 0 1 0 14h-2.5"/>',

  keyboard:
    '<rect x="2.5" y="6" width="19" height="12" rx="2.5"/><path d="M6.2 10h.6M10 10h.6M13.8 10h.6M17.6 10h.6M6.2 14h.6M17.6 14h.6M9.4 14h5.2"/>',

  cards:
    '<rect x="8" y="7.5" width="11.5" height="13" rx="2"/><path d="M8 7.5V5.5a2 2 0 0 1 2-2h8.5a2 2 0 0 1 2 2v10.5a2 2 0 0 1-2 2H17"/>',
...
function sicon(name, cls) {
  ...
  return `<svg class="sicon${
    cls ? " " + cls : ""
  }" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">${p}</svg>`
}
...
function makeDraggable(el, handle) {
  ...
  const onUp = (e) => {
    if (dragging && e && e.pointerId !== undefined && e.pointerId !== pid)
      return
    ...
    try {
      if (pid !== null && handle.hasPointerCapture?.(pid))
...
function applyRemoteStreak(remoteStreak) {
  const local =
    ...
    !Array.isArray(state.streak)
      ? state.streak
      : { count: 0, lastDate: "", days: [] }

  const remote =
    remoteStreak &&
    typeof remoteStreak === "object" &&
    !Array.isArray(remoteStreak)
      ? remoteStreak
      : null
  ...
  cloudSyncTimer = setTimeout(
    async () => {
      ...
      if (
        !result.error &&
        result.data &&
        Number.isFinite(+result.data.version)
      ) {
...
async function pullCloudProfile() {
  ...
  state.profile = {
    ...
    country:
      typeof data.country === "string" ? data.country : state.profile.country,
...
function applyRemoteEquipped(rem) {
  ...
  const badgeList = (src) => {
    ...
    if (Array.isArray(src.badges))
      return [
        ...new Set(src.badges.filter((id) => typeof id === "string" && id)),
      ]
...
async function hydrateCloudState(user) {
  ...
  if (result.data?.state) {
    if (Number.isFinite(+result.data.version))
      lastCloudVersion = +result.data.version
...
function sanitizeState() {
  try {
    ...
    if (
      ...
      typeof state.privacyAccepted !== "object"
    )
      state.privacyAccepted = null
    ...
    for (const k of ["focus", "short", "long"]) {
      ...
      state.timerSeconds[k] = Number.isFinite(s)
...
function toastKey(msg) {
  ...
  for (let i = 0; i < msg.length; i++)
    h = (Math.imul(h, 31) + msg.charCodeAt(i)) | 0
...
function setSyncStatus(mode) {
  const next =
    mode === "offline" ? "offline" : mode === "syncing" ? "syncing" : "online"
...
function avatarMarkup(photo, fallback) {
  return photo ? `<img src="${photo}" alt="Profile photo">` : esc(fallback)
}

function iconStar(id) {
  return `<button type="button" class="favorite ${
    state.favorites.includes(id) ? "on" : ""
  }" data-fav="${id}" title="Favorite">${
    state.favorites.includes(id) ? sicon("star") : sicon("starOutline")
  }</button>`
}
  ...
  $$("[data-fav]", root).forEach(
    (b) =>
      (b.onclick = (e) => {
        ...
        b.innerHTML = state.favorites.includes(id)
          ? sicon("star")
          : sicon("starOutline")
...
function applyDisplay() {
  try {
    document.documentElement.dataset.compact = state.display?.compact ? "1" : ""
  } catch {
    /* ignore */
  }
...
const WHATS_NEW = {
  ...
  items: [
    sicon("bell") +
      " Notification center — chime styles, volume, test button, and per-type alert toggles",

    sicon("bell") +
      " Daily focus nudge at your chosen hour, plus a calm reduce-motion mode",

    sicon("search") +
      " Global search across tasks, groups, techniques, friends and rewards (Ctrl K)",

    sicon("keyboard") +
      " Space starts and pauses the timer from the Focus desk",

    sicon("phone") + " Installable app with an offline shell and its own icon",

    sicon("palette") +
      " Store themes apply instantly · equip avatars, badges and sound packs",
    ...
    sicon("shield") +
      ...
      " Coin Multiplier and " +
      sicon("target") +
      " Double Dip now have real effects",

    sicon("headphones") +
      " Sound studio: true rain, fire, ocean, forest, thunder + layered mixer with timer link",

    sicon("bolt") +
      " Co-focus sprint rooms with live countdowns and finish boards",

    sicon("chart") +
      " Weekly focus chart, group challenges with coin showers, scheduled sessions",

    sicon("camera") +
      " 24-hour stories, @mentions, pinned messages and voice notes in chat",

    sicon("sprout") +
      " Focus garden, focus scores, win journal, records and achievements",

    sicon("bolt") +
      " Session templates, technique of the day, break spinner, boss mode (B)",

    sicon("play") +
      " Auto-start flow with 5-second countdown, custom theme builder, backup import",

    sicon("search") +
      " Compact mode, text sizes, global search, shortcuts and PWA install",

    sicon("gift") +
      " Referrals (+30), guided tour, landing page, confetti everywhere",

    sicon("refresh") + " One-tap refresh when a new version lands",

    sicon("music") +
      " Rebuilt music library: safe imports, play/pause/seek/volume that survives navigation",

    sicon("cards") +
      " True one-card-at-a-time reviews with saved progress, two mystery boxes with staged openings",
  ],
}
...
export function paintBackendPill(surface, root) {
  const pill = (root || document).querySelector(
    `[data-backend-status="${surface}"]`,
  )

  if (!pill) return

  const info = (
    pillResolvers.get(surface) ||
    (() => ({ cls: "local", label: "Local data", title: "", retryable: false }))
  )()
